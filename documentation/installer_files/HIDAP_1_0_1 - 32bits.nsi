...
!define VERSIONBUILD "19-09-2016"
  ...
  OutFile "HIDAP_v1.0_32bits-${MyTIMESTAMP}.exe"
...
Section "Start Menu Shortcuts" SecShortCuts
  ...
  CreateShortcut "$INSTDIR\R-HIDAP.lnk" "$0\bin\i386\Rterm.exe" "" "hidapicon.ico" 0 SW_SHOWMINIMIZED CONTROL|SHIFT|H "${COMPANYNAME} - ${APPNAME}"
